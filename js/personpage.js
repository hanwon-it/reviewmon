...
function renderMoviesGrid(movies, gridId) {
  ...
  grid.innerHTML = movies
    .map(
      (movie) => `
    <div class="search_card" data-movie-id="${
...
async function main() {
  ...
  const directorMovies = (credits.crew || []).filter(
    (m) => m.job === "Director" && m.poster_path
  );
