...
router.get("reviews/search/:type", isAuth, review_controller.get_reviews);

// 2. 해당 영화 전체 리뷰 목록
// GET
// http://{baseUrl}/reviews/movies/:movieId
router.get("reviews/movies/:movieId", review_controller.get_movie_reviews);
...
// DELETE
// http://{baseUrl}/reviews/:idx
router.delete("/reviews/:idx", isAuth, review_controller.delete_review);

// 6. 리뷰 추천순 정렬
// GET
// http://{baseUrl}/reviews/recommand
router.get("/reviews/recommand", review_controller.recommanded_reviews);

// 7. 리뷰 최신순 정렬
// GET
// http://{baseUrl}/reviews/latest
router.get("/reviews/latest", review_controller.latest_reviews);

// 8. 리뷰 평점순 정렬
// GET
// http://{baseUrl}/reviews/rated/:params
router.get("/reviews/rate/:updown", review_controller.rating_reviews);
